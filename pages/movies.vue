<template>
  <section class="container-fluid">
      ...
      <a-col :span="24">
        ...
        <div class="swiper-container">
          ...
          <div class="swiper-wrapper">
            <!-- Slides -->
            <div v-for="(slider, index) in sliders" :key="index" class="swiper-slide">
    ...
    <a-modal title="Add New Video" v-model="visible" :maskClosable="true" onOk="handleOk">
      ...
      <div class="modalcontent">
        <a-form id="components-form-demo-validate-other" @submit="handleSubmit" :form="form">
          ...
          <a-form-item v-bind="formItemLayout" label="Select">
            <a-select
              showSearch
              v-decorator="[
                'year',
          ...
          <a-form-item v-bind="formItemLayout" label="Public">
          ...
          <a-form-item v-bind="formItemLayout" label="Video">
            <div class="dropbox">
              <a-upload-dragger
                name="video"
                :multiple="false"
          ...
          <a-form-item v-bind="formItemLayout" label="thumb">
            <a-upload
              name="thumb"
...
export default {
  ...
  methods: {
    handleOk(e) {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          formData.append(
            'year',
            moment(String(values.year)).format('MM/DD/YYYY')
          )
    ...
    sendThumbs(videoId, episodeId) {
      ...
      this.$axios
        .post(
          'http://localhost:3000/api/tools/genartethumbs',
          { file: 'http://telly.test/api/getvideo/' + videoId },
        ...
        .then(res => {
          ...
          formData.append(
            'vthumbs',
            new File([res.data], 'thumbs.jpg', { type: 'image/jpeg' })
          )
          formData.append('episodeId', episodeId)
          this.$axios.post('/api/v1/savethumbs', formData).then(res => {
            if (res.data.success) {
